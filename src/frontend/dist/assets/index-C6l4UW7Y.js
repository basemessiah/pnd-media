...
function App() {
  ...
  const filteredCampaigns = campaigns.filter(
    (c) => campaignFilter === "all" || campaignCategory[c.id] === campaignFilter
  );
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "results", className: "border-t border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          "data-ocid": "results.filter_toggle",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: campaignFilterOptions.map((opt) => {
                const isActive = campaignFilter === opt.value;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setCampaignFilter(opt.value),
                    className: "px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                    style: isActive ? {
                    ...
                    "data-ocid": `results.filter.${opt.value}`,
                    children: opt.label
                  },
                  opt.value
                );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5 mb-8", children: filteredCampaigns.map((c, i) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => {
              var _a2;
              return (_a2 = document.getElementById("intake-form")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
            },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "intake-form", className: "border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-primary mb-4 font-medium", children: "Get Started" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-bold text-foreground leading-tight mb-4", children: "Start your campaign." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "Fill out the form below and we'll be in touch within 24 hours." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          "data-ocid": "intake.form_wrapper",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "iframe",
            {
              src: "https://tally.so/r/w8Y485",
              width: "100%",
              height: "700",
              frameBorder: 0,
              marginHeight: 0,
