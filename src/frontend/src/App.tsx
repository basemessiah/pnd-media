...
// ─── App ──────────────────────────────────────────────────────────────────────
type CampaignFilter = "all" | "reach" | "conversion";

const campaignFilterOptions: { value: CampaignFilter; label: string }[] = [
  { value: "all", label: "All Campaigns" },
  { value: "reach", label: "Reach" },
  { value: "conversion", label: "Conversion" },
];

// Campaign category tags (01–03 are reach, 04 is conversion)
const campaignCategory: Record<string, CampaignFilter> = {
  "01": "reach",
  "02": "reach",
  "03": "reach",
  "04": "conversion",
...
export default function App() {
  ...
  const filteredCampaigns = campaigns.filter(
    (c) =>
      campaignFilter === "all" || campaignCategory[c.id] === campaignFilter,
  );

  // Load Tally embed script for auto-resizing iframe
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      {/* ── BRAND INTAKE FORM ── */}
      <Section id="intake-form" className="border-t border-border">
